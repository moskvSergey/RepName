...
class Shifts(db.Model):
    ...
    diesel_start = db.Column(db.Integer, nullable=False)
    odometer_end = db.Column(db.Integer, nullable=True, default=None)
    diesel_end = db.Column(db.Integer, nullable=True, default=None)
    refill = db.Column(db.Integer, nullable=True, default=None)
